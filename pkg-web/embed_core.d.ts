...
export class FrameAnalyzer {
    free(): void;
    [Symbol.dispose](): void;
    build_csg_meter_task_frame(csg_param_json: string): string;
    build_csg_normal_task_frame(csg_param_json: string): string;
    build_csg_param_frame(csg_param_json: string): string;
    ...
    get_item_config(item_id: string, protocol: string, region: string): string;
    /**
...
export interface InitOutput {
    ...
    readonly frameanalyzer_build_csg_param_frame: (a: number, b: number, c: number) => [number, number, number, number];
    readonly frameanalyzer_build_csg_read_curdata_frame: (a: number, b: number, c: number) => [number, number, number, number];
    readonly frameanalyzer_build_csg_read_hisdata_frame: (a: number, b: number, c: number) => [number, number, number, number];
